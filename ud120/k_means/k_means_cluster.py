...
for k, v in data_dict.items():
    ...
    if v.get('exercised_stock_options') != 'NaN':
        exercised_stock_options.append(v.get('exercised_stock_options'))
...
pred = KMeans(n_clusters=3, random_state=0).fit_predict(finance_features)
